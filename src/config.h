...
#define LONGITUDE              -47.24078606557139   // CHANGE THIS !!!!! >> CHANGED
#define LATITUDE               -22.820062855172626   // CHANGE THIS !!!!! >> CHANGED
...
#define DSP_DATA_PIN4           30       // LCD data pins
#define DSP_DATA_PIN5           32
#define DSP_DATA_PIN6           34
#define DSP_DATA_PIN7           36
